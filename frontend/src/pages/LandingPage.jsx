    ...
    <div className={landingPageStyles.container}>
      ...
      <main className={landingPageStyles.mainContent}>
          ...
          <div className={landingPageStyles.heroGrid}>
            ...
            <div className={landingPageStyles.heroLeft}>
              ...
              <p className = {landingPageStyles.description}>
                ...
                ATSfriendly , recruiter-approved , and tailored to your career goals.
              </p>
        ...
        <section className = {landingPageStyles.featuresSection}>
          <div className = {landingPageStyles.featureContainer}>
            <div className = {landingPageStyles.featuresHeader}>
              <h2 className = {landingPageStyles.featureTitle}> Why Choose 
              ...
              <p className = {landingPageStyles.featureDescription}>
                Everything you need to create a proffesional resume that stands out 
              </p>
